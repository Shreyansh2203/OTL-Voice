...
os.environ["TEST_MODE"] = "true"  # Enable test mode to skip CSRF and rate limiting
...
def mock_fusion_catalogue():
    with patch("backend.main.fusion_catalogue") as mock:
        ...
        # get_project_by_id is called synchronously in list_timecards, so use MagicMock
