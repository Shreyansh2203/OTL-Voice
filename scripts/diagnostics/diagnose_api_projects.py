...
client = httpx.Client(
    auth=(USERNAME, PASSWORD), timeout=30.0, headers={"Accept": "application/json"}
)
print("Testing ProjectTeamMembers globally...")
resp = client.get(
    f"{host}/fscmRestApi/resources/11.13.18.05/projectTeamMembers", params={"limit": 1}
)
...
resp2 = client.get(
    f"{host}/fscmRestApi/resources/11.13.18.05/projects",
    params={"q": "TeamMembers.PersonName='Prathmesh Nayadkar'", "limit": 1},
)
